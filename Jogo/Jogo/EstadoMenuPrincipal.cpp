...
void EstadoMenuPrincipal::initBackGround()
{
	...
	if (!this->backgroundTexture.loadFromFile("Resources/Images/Backgrounds/background_grafico.png"))
	{
...
void EstadoMenuPrincipal::iniBotoes()
{
	...
	this->botoes["EXIT_STATE"] = new Botao(970, 770, 150, 50,
		&this->font, "Sair", 24,
		sf::Color(33, 33, 33, 33), sf::Color(33, 33, 33, 33), sf::Color(33, 33, 33, 33),
		sf::Color(100, 100, 100, 200), sf::Color(150, 150, 150, 200), sf::Color(20, 20, 20, 200));
}
...
void EstadoMenuPrincipal::renderiza(sf::RenderTarget* alvo)
{
	...
	this->renderBotoes(alvo);

	//sprite.setTexture(ui_manager->cu);
...
{
	/*updeita todos os botoes desse estado e cuida das suas funcionalidades*/
	//main loop
	...
	{
		this->estados->push(new EstadoJogo(this->teclasDisponiveis, this->janela, this->estados));
	}
	...
	//quit the game
	if (this->botoes["EXIT_STATE"]->isPressed())
	{
		this->sair = true;
	}
}

void EstadoMenuPrincipal::renderBotoes(sf::RenderTarget* alvo)
{
	for (auto& it : this->botoes)
	{
